...
var configurations: any[] = [
    ...
    { platforms: ["XPLAT"],
      redirects: [
        ...
        { from: "spreadsheet_chart_adapter.html$", to: "spreadsheet-chart-adapter.html" },
        { from: "spreadsheet_conditional_formatting.html$", to: "spreadsheet-conditional-formatting.html" },
        { from: "spreadsheet_data_validation.html$", to: "spreadsheet-data-validation.html" },
        { from: "excel_library.html$", to: "excel-library" },
        { from: "excel_library_using_cells.html$", to: "excel-library-using-cells.html" },
        { from: "excel_library_using_tables.html$", to: "excel-library-using-tables.html" },
        { from: "excel_library_using_workbooks.html$", to: "excel-library-using-workbooks.html" },
        { from: "excel_library_using_worksheets.html$", to: "excel-library-using-worksheets.html" },
        { from: "excel_library_working_with_charts.html$", to: "excel-library-working-with-charts.html" },
        { from: "excel_library_working_with_sparklines.html$", to: "excel-library-working-with-sparklines.html" },
        { from: "excel_utility.html$", to: "excel-utility" },
        { from: "map_overview.html$", to: "geo-map.html" },
        { from: "map_binding_geographic_csv_files.html$", to: "geo-map-binding-data-csv.html" },
        { from: "map_binding_geographic_json_files.html$", to: "geo-map-binding-data-json-points.html" },
        { from: "map_binding_geographic_data_models.html$", to: "eo-map-binding-data-model.html" },
        { from: "map_binding_geographic_shape_files.html$", to: "geo-map-binding-shp-file.html" },
        { from: "map_binding_multiple_shapes_files.html$", to: "geo-map-binding-multiple-shapes.html" },
        { from: "map_binding_multiple_data_sources.html$", to: "geo-map-binding-multiple-sources.html" },
        { from: "map_displaying_bing_imagery.html$", to: "geo-map-display-bing-imagery.html" },
        { from: "map_displaying_esri_imagery.html$", to: "geo-map-display-esri-imagery.html" },
        { from: "map_displaying_heat_imagery.html$", to: "geo-map-display-heat-imagery.html" },
        { from: "map_displaying_osm_imagery.html$", to: "geo-map-display-osm-imagery.html" },
        { from: "map_navigating_map_content.html$", to: "geo-map-navigation.html" },
        { from: "map_geographic_scatter_area_series.html$", to: "geo-map-type-scatter-area-series.html" },
        { from: "map_geographic_scatter_contour_series.html$", to: "geo-map-type-scatter-contour-series.html" },
        { from: "map_geographic_scatter_density_series.html$", to: "eo-map-type-scatter-density-series.html" },
        { from: "map_geographic_scatter_proportional_series.html$", to: "geo-map-type-scatter-bubble-series.html" },
        { from: "map_geographic_scatter_symbol_series.html$", to: "geo-map-type-scatter-symbol-series.html" },
        { from: "map_geographic_shape_polygon_series.html$", to: "geo-map-type-shape-polygon-series.html" },
        { from: "map_geographic_shape_polyline_series.html$", to: "geo-map-type-shape-polyline-series.html" },
        { from: "map_resources_world_connections.html$", to: "geo-map-resources-world-connections.html" },
        { from: "map_resources_world_locations.html$", to: "geo-map-resources-world-locations.html" },
        { from: "map_resources_world_util.html$", to: "geo-map-resources-world-util.html" },
        { from: "bulletgraph.html$", to: "bullet-graph.html" },
        { from: "lineargauge.html$", to: "linear-gauge.html" },
        { from: "radialgauge.html$", to: "radial-gauge.html" },
        { from: "zoomslider_overview.html$", to: "zoomslider-overview.html" },
      ]
    },
    ...
    { platforms: ["React"],
      redirects: [
        ...
        { from: "grid_table.html$", to: "data-grid.html" },
        { from: "grid_table_remote_databinding.html$", to: "data-grid-remote-data.html" },
        { from: "grid_table_cell_activation.html$", to: "data-grid-cell-activation.html" },
        { from: "grid_table_cell_selection.html$", to: "data-grid-cell-selection.html" },
        { from: "grid_table_column_animation.html$", to: "data-grid-column-animation.html" },
        { from: "grid_table_column_filtering.html$", to: "data-grid-column-filtering.html" },
        { from: "grid_table_column_moving.html$", to: "data-grid-column-moving.html" },
        { from: "grid_table_column_resizing.html$", to: "data-grid-column-resizing.html" },
        { from: "grid_table_column_sorting.html$", to: "data-grid-column-sorting.html" },
        { from: "grid_table_column_sparkline.html$", to: "data-grid-type-sparkline-table.html" },
        { from: "grid_table_column_types.html$", to: "data-grid-column-types.html" },
        { from: "grid_table_performance.html$", to: "data-grid-performance.html" },
        { from: "grid_table_horizontal_scrolling.html$", to: "data-grid-horizontal-scrolling.html" },
        { from: "grid_table_row_grouping.html$", to: "data-grid-row-grouping.html" },
        { from: "grid_table_row_paging.html$", to: "data-grid-row-paging.html" },
        { from: "grid_table_row_pinning.html$", to: "data-grid-row-pinning.html" },
    ]},
    ...
    { platforms: ["React", "WC"],
      ...
      redirects: [
        { from: "categorychart.md$",                                 to: "category-chart.html" },
        { from: "categorychart.html$",                               to: "category-chart.html" },
        { from: "categorychart_annotation_layers.md$",               to: "category-chart-annotations.html" },
        { from: "categorychart_annotation_layers.html$",             to: "category-chart-annotations.html" },
        { from: "categorychart_axis_options.md$",                    to: "category-chart-axis-options.html" },
        { from: "categorychart_axis_options.html$",                  to: "category-chart-axis-options.html" },
        { from: "categorychart_real_time_data.md$",                  to: "category-chart-high-frequency.html" },
        { from: "categorychart_real_time_data.html$",                to: "category-chart-high-frequency.html" },
        { from: "categorychart_high_volume_data.md$",                to: "category-chart-high-volume.html" },
        { from: "categorychart_high_volume_data.html$",              to: "category-chart-high-volume.html" },
        { from: "categorychart_configuration_options.md$",           to: "category-chart-config-options.html" },
        { from: "categorychart_configuration_options.html$",         to: "category-chart-config-options.html" },
        { from: "categorychart_highlighting.md$",                    to: "category-chart-highlighting.html" },
        { from: "categorychart_highlighting.html$",                  to: "category-chart-highlighting.html" },
        { from: "categorychart_tooltip_types.md$",                   to: "category-chart-tooltip-types.html" },
        { from: "categorychart_tooltip_types.html$",                 to: "category-chart-tooltip-types.html" },
        { from: "categorychart_tooltip_templates.md$",               to: "category-chart-tooltip-types.html" },
        { from: "categorychart_tooltip_templates.html$",             to: "category-chart-tooltip-types.html" },
        { from: "datachart.md$",                                     to: "data-chart.html" },
        { from: "datachart.html$",                                   to: "data-chart.html" },
        { from: "datachart_axis_types.md$",                          to: "data-chart-axis-types.html" },
        { from: "datachart_axis_types.html$",                        to: "data-chart-axis-types.html" },
        { from: "datachart_axis_annotations.md$",                    to: "data-chart-axis-annotations.html" },
        { from: "datachart_axis_annotations.html$",                  to: "data-chart-axis-annotations.html" },
        { from: "datachart_axis_settings.html$",                     to: "data-chart-axis-settings.html" },
        { from: "datachart_axis_settings.md$",                       to: "data-chart-axis-settings.html" },
        { from: "datachart_axis_sharing.html$",                      to: "data-chart-axis-sharing.html" },
        { from: "datachart_axis_sharing.md$",                        to: "data-chart-axis-sharing.html" },
        { from: "datachart_chart_legends.md$",                       to: "data-chart-legends.html" },
        { from: "datachart_chart_legends.html$",                     to: "data-chart-legends.html" },
        { from: "datachart_chart_navigation.md$",                    to: "data-chart-navigation.html" },
        { from: "datachart_chart_navigation.html$",                  to: "data-chart-navigation.html" },
        { from: "datachart_chart_synchronization.md$",               to: "data-chart-synchronization.html" },
        { from: "datachart_chart_synchronization.html$",             to: "data-chart-synchronization.html" },
        { from: "datachart_chart_titles.html$",                      to: "data-chart-titles.html" },
        { from: "datachart_chart_titles.md$",                        to: "data-chart-titles.html" },
        { from: "datachart_data_sources.md$",                        to: "data-chart-data-sources.html" },
        { from: "datachart_data_sources.html$",                      to: "data-chart-data-sources.html" },
        { from: "datachart_series_annotations.md$",                  to: "data-chart-series-annotations.html" },
        { from: "datachart_series_annotations.html$",                to: "data-chart-series-annotations.html" },
        { from: "datachart_series_highlighting.md$",                 to: "data-chart-series-highlighting.html" },
        { from: "datachart_series_highlighting.html$",               to: "data-chart-series-highlighting.html" },
        { from: "datachart_series_markers.md$",                      to: "data-chart-series-markers.html" },
        { from: "datachart_series_markers.html$",                    to: "data-chart-series-markers.html" },
        { from: "datachart_series_tooltips.md$",                     to: "data-chart-series-tooltips.html" },
        { from: "datachart_series_tooltips.html$",                   to: "data-chart-series-tooltips.html" },
        { from: "datachart_series_trendlines.md$",                   to: "data-chart-series-trendlines.html" },
        { from: "datachart_series_trendlines.html$",                 to: "data-chart-series-trendlines.html" },
        { from: "datachart_series_value_overlay.md$",                to: "data-chart-value-overlay.html" },
        { from: "datachart_series_value_overlay.html$",              to: "data-chart-value-overlay.html" },
        { from: "datachart_series_types.html$",                      to: "data-chart-series-types.html" },
        { from: "datachart_series_types.md$",                        to: "data-chart-series-types.html" },
        { from: "datachart_series_types_category.md$",               to: "data-chart-series-types.html" },
        { from: "datachart_series_types_category.html$",             to: "data-chart-series-types.html" },
        { from: "datachart_series_types_financial.md$",              to: "data-chart-types-overview-financial.html" },
        { from: "datachart_series_types_financial.html$",            to: "data-chart-types-overview-financial.html" },
        { from: "datachart_series_types_polar.md$",                  to: "data-chart-type-polar-line-series.html" },
        { from: "datachart_series_types_polar.html$",                to: "data-chart-type-polar-line-series.html" },
        { from: "datachart_series_types_radial.md$",                 to: "data-chart-type-radial-line-series.html" },
        { from: "datachart_series_types_radial.html$",               to: "data-chart-type-radial-line-series.html" },
        { from: "datachart_series_types_range.md$",                  to: "data-chart-type-range-column-series.html" },
        { from: "datachart_series_types_range.html$",                to: "data-chart-type-range-column-series.html" },
        { from: "datachart_series_types_scatter_bubble.md$",         to: "data-chart-type-scatter-bubble-series.html" },
        { from: "datachart_series_types_scatter_bubble.html$",       to: "data-chart-type-scatter-bubble-series.html" },
        { from: "datachart_series_types_scatter_area.md$",           to: "data-chart-type-scatter-area-series.html" },
        { from: "datachart_series_types_scatter_area.html$",         to: "data-chart-type-scatter-area-series.html" },
        { from: "datachart_series_types_scatter_contour.md$",        to: "data-chart-type-scatter-contour-series.html" },
        { from: "datachart_series_types_scatter_contour.html$",      to: "data-chart-type-scatter-contour-series.html" },
        { from: "datachart_series_types_scatter_marker.md$",         to: "data-chart-type-scatter-point-series.html" },
        { from: "datachart_series_types_scatter_marker.html$",       to: "data-chart-type-scatter-point-series.html" },
        { from: "datachart_series_types_shape.md$",                  to: "data-chart-type-scatter-polygon-series.html" },
        { from: "datachart_series_types_shape.html$",                to: "data-chart-type-scatter-polygon-series.html" },
        { from: "datachart_series_types_stacked.md$",                to: "data-chart-type-stacked-column-series.html" },
        { from: "datachart_series_types_stacked.html$",              to: "data-chart-type-stacked-column-series.html" },
        { from: "financialchart.html$",                              to: "financial-chart.html" },
        { from: "financialchart_binding_live_data.html$",            to: "financial-chart-high-frequency.html" },
        { from: "financialchart_binding_large_data.html$",           to: "financial-chart-high-volume.html" },
        { from: "financialchart_binding_multiple_sources.html$",     to: "financial-chart-multiple-data.html" },
        { from: "financialchart_chart_annotations.html$",            to: "financial-chart-chart-annotations.html" },
        { from: "financialchart_chart_configuration.html$",          to: "financial-chart.html" },
        { from: "financialchart_chart_display_types.html$",          to: "financial-chart.html" },
        { from: "financialchart_chart_panes.html$",                  to: "financial-chart-chart-panes.html" },
        { from: "financialchart_chart_performance.html$",            to: "financial-chart-chart-performance.html" },
        { from: "financialchart_custom_indicators.html$",            to: "financial-chart.html" },
        { from: "financialchart_tooltip_types.html$",                to: "financial-chart.html" },
        { from: "financialchart_tooltip_templates.html$",            to: "financial-chart.html" },
        { from: "doughnutchart.md$",                                 to: "doughnut-chart.html" },
        { from: "doughnutchart.html$",                               to: "doughnut-chart.html" },
        { from: "piechart.md$",                                      to: "pie-chart.html" },
        { from: "piechart.html$",                                    to: "pie-chart.html" },
    ]},
        ...
        for (const config of configurations) {
            ...
            if (config.platforms.includes(platform.name)) {
                ...
                for (const redirect of config.redirects) {
                  ...
                  if (!actionURL.endsWith('.html')) actionURL += '.html';
