...
var configurations: any[] = [
    ...
    { platforms: ["React"],
      redirects: [
        ...
        { from: "grid_table.html$",                      to: "grids/data-grid/overview" },
    ]},
    ...
    { platforms: ["React", "Blazor", "WC"],
      redirects: [
        ...
        { from: "data-grid.html$"                         , to: "grids/data-grid/overview" }
      ]
    },
    // redirects for moved data-grid topics to sub folder in 23.1 release
    { platforms: ["React", "Blazor", "WC"],
      redirects: [
        { from: "grids/data-grid-accessibility",         to: "grids/data-grid/accessibility" },
        { from: "grids/data-grid-cell-activation",       to: "grids/data-grid/cell-activation" },
        { from: "grids/data-grid-cell-editing",          to: "grids/data-grid/cell-editing" },
        { from: "grids/data-grid-cell-merging",          to: "grids/data-grid/cell-merging" },
        { from: "grids/data-grid-cell-selection",        to: "grids/data-grid/cell-selection" },
        { from: "grids/data-grid-column-animation",      to: "grids/data-grid/column-animation" },
        { from: "grids/data-grid-column-chooser",        to: "grids/data-grid/column-chooser" },
        { from: "grids/data-grid-column-filtering",      to: "grids/data-grid/column-filtering" },
        { from: "grids/data-grid-column-moving",         to: "grids/data-grid/column-moving" },
        { from: "grids/data-grid-column-options",        to: "grids/data-grid/column-options" },
        { from: "grids/data-grid-column-pinning",        to: "grids/data-grid/column-pinning" },
        { from: "grids/data-grid-column-resizing",       to: "grids/data-grid/column-resizing" },
        { from: "grids/data-grid-column-sorting",        to: "grids/data-grid/column-sorting" },
        { from: "grids/data-grid-column-summaries",      to: "grids/data-grid/column-summaries" },
        { from: "grids/data-grid-column-types",          to: "grids/data-grid/column-types" },
        { from: "grids/data-grid-horizontal-scrolling",  to: "grids/data-grid/horizontal-scrolling" },
        { from: "grids/data-grid-live-data",             to: "grids/data-grid/live-data" },
        { from: "grids/data-grid-load-save-layout",      to: "grids/data-grid/load-save-layout" },
        { from: "grids/data-grid-local-data",            to: "grids/data-grid/local-data" },
        { from: "grids/data-grid-localization",          to: "grids/data-grid/localization" },
        { from: "grids/data-grid-performance",           to: "grids/data-grid/performance" },
        { from: "grids/data-grid-remote-data",           to: "grids/data-grid/remote-data" },
        { from: "grids/data-grid-row-grouping",          to: "grids/data-grid/row-grouping" },
        { from: "grids/data-grid-row-highlighting",      to: "grids/data-grid/row-highlighting" },
        { from: "grids/data-grid-row-paging",            to: "grids/data-grid/row-paging" },
        { from: "grids/data-grid-row-pinning",           to: "grids/data-grid/row-pinning" },
        { from: "grids/data-grid-type-comparison-table", to: "grids/data-grid/type-comparison-table" },
        { from: "grids/data-grid-type-heatmap-table",    to: "grids/data-grid/type-heatmap-table" },
