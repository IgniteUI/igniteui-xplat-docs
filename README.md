...
`./docfx/en/components/toc.json`
  ...
  - If you want to add status specifix only to a single platform you can set the property status like this `status = ["NEWREACT", "PREVIEWBLAZOR", "UPDATEDWEBCOMPONENTS"]`
