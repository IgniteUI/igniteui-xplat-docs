...
<code-view style="height: 400px" 
           ...
           iframe-src="{environment:dvDemosBaseUrl}/charts/data-chart-type-category-waterfall-series" alt="$PlatformShort$ ウォーターフォール チャートの例">
</code-view>
...
`WaterfallSeries` を作成するには、以下のモジュールが必要です。
