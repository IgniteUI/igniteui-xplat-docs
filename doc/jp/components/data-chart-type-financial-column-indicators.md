---
title: $Platform$ データ チャート | データ可視化ツール | 財務指標 (縦棒) | インフラジスティックス
_description: インフラジスティックスの $Platform$ チャート コントロールを使用して財務指標 (縦棒) を表示します。$ProductName$ グラフ タイプについて説明します。
_keywords: $Platform$ charts, data chart, financial column indicators, $ProductName$, Infragistics, $Platform$ チャート, データ チャート, 縦棒型の財務指標, インフラジスティックス
