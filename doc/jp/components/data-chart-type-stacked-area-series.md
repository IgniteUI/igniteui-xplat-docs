---
title: $Platform$ データ チャート | データ可視化ツール | 積層型エリア チャート | データ バインディング | インフラジスティックス
_description: インフラジスティックスの $Platform$ チャート コントロールを使用して積層型エリア チャートを作成します。$ProductName$ グラフ タイプについて説明します。
_keywords: $Platform$ charts, data chart, stacked area charts, $ProductName$, Infragistics, $Platform$ チャート, データ チャート, 積層型エリア チャート, インフラジスティックス
...
## 軸の要件
$Platform$ データ チャート コンポーネントはさまざまなタイプの軸を提供しますが、`StackedAreaSeries` で使用できるのは以下のタイプの軸のみです。
