...
You can create {Platform} Step Area Chart in the `CategoryChart` control by setting `CategoryChart.ChartType` property to `StepArea` value, as shown in the example below.
