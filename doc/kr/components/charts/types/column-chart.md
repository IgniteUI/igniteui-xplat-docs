...
You can create this type of chart in the `CategoryChart` control by binding your data and setting `CategoryChart.ChartType` to Column enum, as shown in the example below:
...
You can create this type of chart in the `CategoryChart` control by binding your data and setting the `CategoryChart.ChartType` property to `Column`, as shown in the example below:
...
The Column Chart is able to render multiple columns per category for comparison purposes. You can create this type of chart in the `CategoryChart` control by binding your data and setting the `CategoryChart.ChartType` property to `Column`, as shown in the example below:
