...
You can create Stock Chart using the `FinancialChart` control by binding your data and optionally setting `FinancialChart.ChartType` property to `Line` value, as shown in the example below.
