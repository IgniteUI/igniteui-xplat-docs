...
The {ProductName} map control has the ability to show heat-map imagery through the use of the `ShapeFileRecord` that are generated by a `ShapeDataSource` by loading geo-spatial data by loading shape files to a tile series.
