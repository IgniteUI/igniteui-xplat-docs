...
<sample-button src="charts/data-chart/type-contour-series"></sample-button>
...
## 필요한 축
`XamDataChart` 제어는 다양한 유형의 축을 제공하며, `NumericYAxis` 및 `NumericYAxis`만 `ScatterContourSeries`와 함께 사용할 수 있습니다.
