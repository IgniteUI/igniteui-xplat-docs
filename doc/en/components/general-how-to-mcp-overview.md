---
title: Ignite UI MCP Overview | {ProductName} | Infragistics
_description: Learn what Ignite UI MCP is and choose the right {Platform} MCP workflow topic to start with.
_keywords: {Platform}, {ProductName}, Infragistics, MCP, Model Context Protocol, Ignite UI MCP, AI, Ignite UI CLI MCP, Ignite UI Theming MCP
_language: en
mentionedTypes: []
---
...
Together, they help the assistant create a {Platform} project, continue setup work, support theming tasks, and answer product questions from chat.
...
Some workflows also assume you already have a {Platform} project or that you want to create one in a new empty folder.
...
- start from a completely empty folder and let MCP help create the {Platform} project
- create the {Platform} project with Ignite UI CLI first, then continue with MCP
- connect MCP to a {Platform} project that already exists and continue working in the current codebase
...
> **Start from an Empty Folder with MCP for {Platform}**: use this when you want MCP to help create the {Platform} project from the beginning.

> **Create an {Platform} Project with Ignite UI CLI, then Continue with MCP**: use this when you want to create the {Platform} project first and use MCP after that.
