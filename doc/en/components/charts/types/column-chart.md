...
The Stacked 100% Column Chart is identical to the [Stacked Column Charts](stacked-chart.md#$PlatformShort$-stacked-column-chart) in all aspects except in their treatment of the values on Y-Axis. Instead of presenting a direct representation of the data, the Stacked 100 Column Chart presents the data in terms of percent of the sum of all values in a data point.
...
The Radial Column Chart belongs to a group of [Radial Charts](radial-chart.md), and is visualized by using a collection of rectangles that extend from the center of the chart toward the locations of data points. This utilizes the same concepts of data plotting as the [Category Column Charts](column-chart.md#$PlatformShort$-category-column-chart), but wraps data points around a circle rather than stretching them along a horizontal line.
