...
_description: Use Infragistics' $Platform$ charts control to create stacked spline charts. Learn about our $ProductName$ graph types!
_keywords: $Platform$ charts, data chart, stacked spline charts, $ProductName$, Infragistics
...
## Required Axes
The $Platform$ data chart component provides various types of axes but only the following types of axes can be used with `StackedSplineSeries`.
