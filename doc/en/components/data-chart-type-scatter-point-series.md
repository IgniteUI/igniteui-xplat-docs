...
<code-view style="height: 500px" 
           ...
           iframe-src="{environment:dvDemosBaseUrl}/charts/data-chart-type-scatter-point-series" alt="$PlatformShort$ Scatter Point Chart Example">
</code-view>
...
Creation of the `ScatterSeries` requires the following modules:
