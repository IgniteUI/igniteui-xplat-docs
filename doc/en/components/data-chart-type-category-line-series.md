...
<code-view style="height: 400px" 
           ...
           iframe-src="{environment:dvDemosBaseUrl}/charts/data-chart-type-category-line-series" alt="$PlatformShort$ Line Chart Example">
</code-view>
...
Creation of the `LineSeries` requires the following modules:
