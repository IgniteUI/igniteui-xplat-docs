...
The {ProductName} Cell Selection in {Platform} {ComponentTitle} enables rich data select capabilities and offers powerful API in the `{ComponentTitle}` component. The {Platform} {ComponentTitle} supports three selection modes:
