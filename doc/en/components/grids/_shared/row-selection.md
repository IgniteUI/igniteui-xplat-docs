...
The {Platform} {ComponentTitle} Row Selection in {ProductName} allows users to interactively select, highlight, or deselect a single or multiple rows of data. There are several selection modes available:
- None Selection 
- Multiple Selection
- Single Selection
