---
title: $Platform$ Data Chart | Data Visualization Tools | Financial Area Indicators | Infragistics
_description: Use Infragistics' $Platform$ charts control to display financial area indicators. Learn about our $ProductName$ graph types!
_keywords: $Platform$ charts, data chart, financial area indicators, $ProductName$, Infragistics
mentionedTypes: ['XamDataChart', 'FinancialPriceSeries']
---
# $Platform$ Financial Area Indicators
