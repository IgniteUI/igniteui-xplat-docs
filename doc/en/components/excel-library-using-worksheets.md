---
title: $PlatformShort$ Excel Library| Using Worksheets | Infragistics
_description: Use Infragistics' $PlatformShort$ excel library to input data by working with the worksheet's row and cells and setting thier corresponding values. Easily transfer data from $ProductName$ excel to your application!
...
---
# $PlatformShort$ Using Worksheets
...
<code-view style="height: 200px" 
           ...
           iframe-src="{environment:dvDemosBaseUrl}/excel/excel-library-operations-on-worksheets" alt="$PlatformShort$ Using Worksheets Example">
</code-view>
