...
_description: Use the Ignite UI Theming MCP server to generate {ProductName} palettes, themes, typography, and design token overrides through your AI assistant.
