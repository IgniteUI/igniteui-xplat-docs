...
_language: en
_license: MIT
_canonicalLink: "{environment:dvUrl}/components/cli-mcp-start-cli"
...
If you want the AI assistant to create the {Platform} project without running the CLI yourself, see [Start from an Empty Folder with Ignite UI CLI MCP for {Platform}](cli-mcp-start-empty.md).
