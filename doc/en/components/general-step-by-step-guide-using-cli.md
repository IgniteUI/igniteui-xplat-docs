...
- The **custom** option generates a Sass-based color palette and theme configuration using the [Theming API](./ai/theming-mcp.md).
...
You will be provided with a list of available component templates, grouped by category. Use the arrow keys to navigate through the groups and ENTER to select.

After selecting a group, choose a specific template from the list and enter a name for the new component.
