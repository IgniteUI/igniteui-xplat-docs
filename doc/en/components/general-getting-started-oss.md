...
This topic provides a step-by-step guide on how to use Grid Lite in your {Platform} app

## Overview
The **igniteui-grid-lite** package provides a lightweight, open-source data grid for {Platform} and other javascript-based front-end applications, available under the MIT license.

## Install Grid Lite

The Grid Lite package for {Platform} contains open-source UI components delivered via npm or yarn.
