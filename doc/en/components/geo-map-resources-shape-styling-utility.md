---
title: $PlatformShort$ Map | Shape Map Resources | Infragistics
...
_keywords: $PlatformShort$ map, shape styling, conditional formatting, $ProductName$, Infragistics
mentionedTypes: ['XamGeographicMap']
---
# $PlatformShort$ Shape Styling Utility

The resource topic provides implementation of an utility that helps with styling UI elements of `GeographicShapeSeries` in $PlatformShort$ `XamGeographicMap` component.
