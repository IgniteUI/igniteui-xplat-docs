---
title: Charts & Maps Changelog
_description: Complete changelog for chart, map, gauge, and dashboard components across all platforms
_keywords: Charts, Maps, Gauges, Dashboards, Changelog
---

# Charts & Maps Changelog

All notable changes for chart-related components in {ProductName} across all platforms.

> [!Note]
> This changelog includes content for {PackageCharts}, {PackageMaps}, {PackageGauges}, and {PackageDashboards} packages.
...
- Changed Scatter High Density seriesâ€™ colors for heat min property from <span style="color:#8a5bb1">#8a5bb1</span> to <span style="color:#000000">#000000</span>
- Changed Scatter High Density seriesâ€™ colors for heat max property from <span style="color:#ee5879">#ee5879</span> to <span style="color:#ee5879">#ee5879</span>
- Changed Financial/Waterfall seriesâ€™ `NegativeBrush` and `NegativeOutline` properties from <span style="color:#C62828">#C62828</span> to <span style="color:#ee5879">#ee5879</span>
