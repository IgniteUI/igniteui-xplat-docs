...
```tsx
<IgrDockManager id="dockManager"></IgrDockManager>
```
...
<IgrDockManager id="dockManager">
  <div slot="content1" style={{ width: "100%", height: "100%" }}>
    Content 1
  </div>
</IgrDockManager>
```
...
<igc-dockmanager id="dockManager">
  ...
  <button slot="maximizeButton">
    <img
      src="https://www.svgrepo.com/show/419558/arrow-top-chevron-chevron-top.svg"
      alt="arrow-top-chevron-chevron-top"
    />
  </button>

  <button slot="minimizeButton">
    <img
      src="https://www.svgrepo.com/show/419557/bottom-chevron-chevron-down.svg"
      alt="bottom-chevron-chevron-down"
    />
  </button>
