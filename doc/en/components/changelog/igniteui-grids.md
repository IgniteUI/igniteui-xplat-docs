...
- `DisplayDensity` deprecated in favor of the `--ig-size` CSS custom property. Check out the [Grid Size](~/components/grids/_shared/size.md) topic for more.
...
- Added New Features - [State Persistence](~/components/grids/_shared/state-persistence.md)

## **{PackageVerChanges-23-2}**

<!-- React, WebComponents -->
- [Grid](~/components/grids/data-grid.md) - This is a new fully functional cross-platform grid and includes features like filtering, sorting, templates, row selection, row grouping, row pinning and movable columns.
<!-- end: React, WebComponents -->

<!-- Blazor -->
- [Grid](~/components/grids/data-grid.md) - New grid component with features like filtering, sorting, templates, row selection, row grouping, row pinning and movable columns.
<!-- end: Blazor -->

### Deprecated Components

> [DataGrid](~/components/grids/data-grid/overview.md) - The DataGrid is deprecated, please use [Grid](~/components/grids/data-grid.md)

## **{PackageVerChanges-23-2-MAR}**

### {PackageGrids}

- New [`HierarchicalGrid`](~/components/grids/hierarchical-grid/overview.md) component
...
- New [Pivot Grid](~/components/grids/pivot-grid/overview.md) component.

## **{PackageVerChanges-22-2}**

### {PackageGrids}

- New [Grid](~/components/grids/data-grid.md) component.
- New [Tree Grid](~/components/grids/tree-grid/overview.md) component.
