...
mentionedTypes: ["SeriesViewer", "XYChart", "DomainChart", "XamDataChart", "Toolbar", "XamDataLegend", "XamDataPieChart", "ComponentBase"]
namespace: Infragistics.Controls.Charts
---

# {ProductName} Charts Changelog
...
<img class="responsive-img" src="../../images/charts/data-chart-user-annotation-create.gif" alt="{Platform} user-annotation-create"/>
...
The following events have been added to the data chart to allow you to detect different operations on the axis labels:
