---
title: Use Ignite UI CLI MCP in an Existing Project | {ProductName} | Infragistics
_description: Learn how to add Ignite UI MCP to an existing {Platform} project, verify the tools, continue working in the current codebase, and use MCP to ask documentation and API questions.
_keywords: {Platform}, {ProductName}, Infragistics, MCP, Model Context Protocol, Ignite UI MCP, Ignite UI CLI MCP, Ignite UI Theming MCP, AI, documentation, API
_language: en
mentionedTypes: []
---
...
This guide shows how to connect Ignite UI MCP to a {Platform} project that already exists and continue working in the current codebase.

It also shows how to use MCP in chat to ask documentation questions about {Platform} components, configuration, and available API members.
...
If you are using an editor-based client, open the existing {Platform} project there.

If you are using a desktop or chat-first client, keep the existing {Platform} project available as the project context you want to work with.
...
Once the tools are available, continue in chat and ask the assistant to work with the current {Platform} project instead of creating a new one.
...
You can also use chat to ask questions about {Platform} documentation while working in the existing project.

The `igniteui` MCP server can help you continue working in the current codebase, make project and component changes, and ask documentation questions about {Platform} components, features, and API members.
...
Now that MCP is connected to your existing {Platform} project, you can use chat to continue building, refactoring, and asking product questions without starting from scratch.
...
If you want to create the {Platform} project with Ignite UI CLI first and continue after that, see [Create a Project with Ignite UI CLI, then Continue with MCP](general-how-to-start-mcp-cli-project.md).
