...
To get started with the [IgcNavigationDrawerComponent]({environment:wcApiUrl}/classes/igcnavdrawercomponent.html), first you need to install $ProductName$ by executing the following command:
